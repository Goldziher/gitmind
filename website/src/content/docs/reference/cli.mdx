...
basemind agent [prompt] [--resume --continue --daemon --attach --replay]
basemind ui [--root <path>]
...
| `agent [prompt] [--resume --continue --daemon --attach --replay]` | Launch the basemind agent TUI (a coding agent over the code map). |
| `ui [--root <path>]` | Launch the basemind desktop UI (an interactive code graph over the code map). |
